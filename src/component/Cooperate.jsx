  ...
  return (
    <div className=' bg-cover flex flex-col  h-screen bg-center bg-[url("/images/And.jpg")]'>
      <div className='w-full h-full flex flex-col gap-8 justify-center items-center '>
        <h1 className='text-8xl font-bold text-center'>LET'S BEGIN <span className='block bg-gradient-to-r from-indigo-600 via-pink-500 to-pink-700 bg-clip-text text-transparent'> COOPERATION </span></h1>
