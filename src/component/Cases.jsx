      ...
      <div className='w-full flex flex-col md:gap-16'>
        ...
        <div className='flex md:flex-row flex-col md:gap-14'>
           ...
           <div className='flex flex-col justify-between '>
             ...
             <p className=''>01<span className='text-gray-700'>/00 </span></p>
           </div>
            ...
            <div className='w-70' >
                <h1 className='text-[14px] font-bold h-20 '>Increased website traffic by 150%, increased conversion rate by 30%</h1>

                <p  className='font-bold text-xl bg-gradient-to-r text-transparent bg-clip-text from-pink-500 via-purple-500 to-purple-700 '>AFTER</p>
            </div>

            </div>

            <p className='text-sm w-1/2 text-gray-700'>
                Cooperation with DigitalPro has taken our business to a next level. we don't just sell products but who support green living.
                Their Strategies really work and we are happy to be part of this team 
